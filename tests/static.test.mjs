...
assert.equal(manifest.start_url, './index.html?v=51');
...
assert.ok(css.includes("./assets/marble-light-v51.webp") && css.includes("./assets/marble-dark.webp"), 'both approved marble systems are included');
...
assert.ok(sw.includes('./assets/marble-light-v51.webp') && sw.includes('./assets/marble-dark.webp'), 'both theme backgrounds work offline');
