const CACHE='al-majlis-v14';
const ASSETS=['./','./index.html','./manifest.webmanifest','./al-majlis-icon.svg','./apple-touch-icon.png','./icon-192.png','./icon-512.png','./icon-maskable-512.png'];
